...
workbook = xlsxwriter.Workbook('inventaireDesOS.xlsx')
...
print("\nTotal de machines =",len(compname),"\n\tSous Windows 11 =",len(win11)-2,"\n\tSous Windows 10 =",len(win10)-2,
      "\n\tSous autres OS (7,8,voire version serveurs) =",len(otherOS)-2)